...
namespace _Game.Features.MyShip
{
    public class ShipConfigManager : MonoBehaviour//, IDropHandler, IPointerEnterHandler, IPointerExitHandler, IPointerMoveHandler
    {
        ...
        // }
        //
        // public ShipSetupItem PlaceItem(InventoryItem item, Vector2Int position)
        // {
        ...
        // }
        //
        // private void MoveItem(ShipSetupItem shipSetupItem, Vector2Int position)
        // {
        //     Debug.Log("cell.Position: " + position);
        //     
        ...
        //             _shipSetupItem.Position = cell.Position;
        //         }
        //         else
        //         {
        //             MoveItem(_shipSetupItem, cell.Position);
        //             _shipSetupItem.Position = cell.Position;
        //         }
        //     }
        //     else
        ...
        //         MoveItem(_shipSetupItem, _shipSetupItem.Position);
        //     }
        //
        ...
        //     if (!_shipSetupItem)
        //     {
        //         _shipSetupItem = eventData.pointerDrag.GetComponent<ShipSetupItem>();
        ...
        //
        //     if (!hoveredCell || !_shipSetupItem) return;
        //
