...
namespace Slash.Unity.DataBind.Core.Utils
{
    ...
    public static class ReflectionUtils
    {
        ...
        public static int GetEventListenerCount<TType>(TType obj, string eventName)
        {
            var fieldInfo = typeof(TType).GetField(eventName, BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
            var eventDelegate = fieldInfo.GetValue(obj) as MulticastDelegate;
            if (eventDelegate == null || eventDelegate.GetInvocationList() == null)
            {
                return 0;
            }
