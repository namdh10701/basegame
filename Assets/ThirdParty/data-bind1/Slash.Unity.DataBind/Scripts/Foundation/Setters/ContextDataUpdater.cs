...
namespace Slash.Unity.DataBind.Foundation.Setters
{
    ...
    public class ContextDataUpdater : DataBindingOperator
    {
        ...
        /// <summary>
        ///     Indicates that no context update is done on activation, but only after the data changed.
        /// </summary>
        [Tooltip("Indicates that no context update is done on activation, but only after the data changed. " + 
                 "You may want to use this if you have a two-way binding and want to make sure that the context data has precedence.")]
        public bool NoInitialUpdate;
        ...
        public override void Enable()
        {
            ...
            this.Data.ValueChanged += this.OnDataChanged;
            if (this.Data.IsInitialized && !this.NoInitialUpdate)
            {
                this.OnDataChanged();
            }
        }
